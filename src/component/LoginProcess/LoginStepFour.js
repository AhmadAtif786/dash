...
import loginverify from "../images/verify.png";
...
<div class="verification_step_four_container">
  <div class="verification_step_four_figure"><img src={loginverify} /></div>
  <div class="verification_step_four_heading">
    <p>Congratulations</p>
    <span>Your 2-Step Verification process is successfully completed</span>
  </div>
