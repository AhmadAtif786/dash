...
import "../css/LoginProcess.css";
import loginphone from "../images/phone.png";
...
<div class="verification_step_two_container">
  ...
  <div class="verification_step_two_bread_crums"><span>Step 1 of 2</span></div>
 <div class="verification_step_two_box">
  ...
  <form>
   ...
   <figure><img src={loginphone} /></figure>
  ...
  <input type="text" placeholder="mobile number" />
    ...
    <div class="verification_step_two_option_field">
      ...
      <div class="verification_step_two_option_field_data"><input type="radio" /><span>Text Message</span></div>
      <div class="verification_step_two_option_field_data"><input type="radio" /><span>Phone Call</span></div>
      </div>
    </div>
</form>
